            ...
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <form class="flex items-center w-[539px]">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[8px] focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Search" />
                    </div>
